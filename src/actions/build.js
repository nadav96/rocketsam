...
module.exports = {
	build: async function() {
		...
		let result = await selector.render()
...
async function functionBuildFolder(functionName, dependencies) {
	...
	ncp(`${appDir}/${functionName}`, functionBuildFolder, function (err) {
	 if (err) {
	...
	// await populateFunctionCommonFolder(functionName, dependencies, buildDir, false)
	// await fs.copyFileSync(srcTarget, dstTarget);
}